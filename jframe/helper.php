<?php
/**
 * helper函数库，核心框架不依赖该函数库
 * @authors Jea杨 (JJonline@JJonline.Cn)
 * @date    2017-01-04 15:13:05
 * @version $Id$
 */
...
if (!function_exists('nl2p')) {
    ...
    */ 
    function reversible_crypt($string, $isDecode = false, $key = 'JFrame', $expiry = 0)
    {
        $ckey_length            =   4;
        // 密匙
        $key                    =   md5($key ? $key : 'JFrame'); 
        // 密匙a会参与加解密
...
if (!function_exists('format_bytes')) {
     ...
     * @param  boolean $is_clear_ahref 是否清理a标签，默认不清理
     * @return string  清理妥善的html文本
     */
    function clear_html_xss($content,$is_clear_ahref = false)
    {
        ##去除所有JavaScript代码
        ...
        if($is_clear_ahref)
        {
            $content = preg_replace('/<\/?a[^>]>/', '', $content); ##a标签相对危害小一些，依据实际情况传参
        }

        ##去除标签内的各种属性  排除对img、a标签的误杀--留意img的js事件可能会漏网之鱼
...
if (!function_exists('is_mail_valid')) {
    /**
...
if (!function_exists('is_phone_valid')) {
    /**
     * 检测传入的变量是否为天朝手机号
     * @param  mixed $mail
     * @return boolean
...
if (!function_exists('is_uid_valid')) {
    /**
...
if (!function_exists('is_password_valid')) {
    /**
...
if (!function_exists('is_citizen_id_valid')) {
    /**
